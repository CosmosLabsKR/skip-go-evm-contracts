 ...
 * @notice The amount-independent burn parameters, checked identically by TransitExecutor and TransitForwarder.
 *
 ...
 *
 *      Note these describe the OUTBOUND (CCTP v2) burn, not the v1 message being received.
 */
library TransitBurnParams {
    ...
    function check(uint256 feeAmount, uint32 minFinalityThreshold) internal pure {
